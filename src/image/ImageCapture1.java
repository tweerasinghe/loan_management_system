...
import static customer.Customer.uc_customerImage;

public class ImageCapture1 extends JFrame implements Runnable, WebcamListener, WindowListener, UncaughtExceptionHandler, ItemListener, WebcamDiscoveryListener {
...
//            new Dimension(100, 100),};
        ...
        webcam.addWebcamListener(ImageCapture1.this);
        ...
        JButton b = new JButton(new AbstractAction("Take Snapshot Now") {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(ImageCapture1.this, "SAVED", "Info", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    Customer.uc_customerImage.setIcon(new ImageIcon(fullName));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new ImageCapture1());
    }
