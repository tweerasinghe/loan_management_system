...
public class loan_function {
    ...
    //getters setters to document
    public static String CID = "", LOANID = "";
    ...
    public void setLOANID(String LOANID) {
        loan_function.LOANID = LOANID;
    }

    //set and Get Genarated Loan ID
    String GenaratedLoanID = "";

    public String getGenaratedLoanID() {
        return GenaratedLoanID;
    }

    public void setGenaratedLoanID(String GenaratedLoanID) {
        this.GenaratedLoanID = GenaratedLoanID;
    }
    ...
    public String[] getDateAndTime() {
        ...
        data[0] = dateFormat.format(cal.getTime());
        data[1] = datetime.format(cal.getTime());
        cal.add(Calendar.DATE, 30);
        data[2] =dateFormat.format(cal.getTime());
        return data;
